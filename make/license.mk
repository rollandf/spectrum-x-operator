...
COPYRIGHT_FLAGS         ?= -s
COPYRIGHT_EXCLUDE       ?= vendor deployment config bundle .* **/testdata/*
...
third-party-licenses: go-licenses
	...
	@GOROOT=$(shell go env GOROOT) $(GO_LICENSES) save ./... --save_path=third_party_licenses --ignore=github.com/ajeddeloh/go-json
